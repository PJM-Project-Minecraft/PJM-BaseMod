...
public final class ClientPacketHandlersImpl implements ClientPacketProxy {
    ...
    @Override
    public void baseZoneMapSync(ru.liko.pjmbasemod.common.network.packet.BaseZoneMapSyncPacket payload) {
        ru.liko.pjmbasemod.client.basezone.ClientBaseZoneState.update(payload);
    }
    ...
    @Override
    public void mapMarkerSync(ru.liko.pjmbasemod.common.network.packet.MapMarkerSyncPacket payload) {
        ru.liko.pjmbasemod.client.mapmarker.ClientMapMarkerState.update(payload);
    }

    @Override
    public void missileCatalogSync(ru.liko.pjmbasemod.common.network.packet.MissileCatalogSyncPacket payload) {
        ru.liko.pjmbasemod.client.missile.ClientMissileState.update(payload);
    }

    @Override
    public void missileAudioSync(ru.liko.pjmbasemod.common.network.packet.MissileAudioSyncPacket payload) {
        ru.liko.pjmbasemod.client.missile.MissileSoundController.handleSync(payload);
    }

    @Override
    public void missileImpact(ru.liko.pjmbasemod.common.network.packet.MissileImpactPacket payload) {
        ru.liko.pjmbasemod.client.missile.ClientMissileState.addImpact(payload);
    }
