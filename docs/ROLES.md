...
- `>0` — максимум онлайн-игроков этой роли в выбранной scoreboard-фракции.

Лимиты проверяются сервером для первого выбора, radial menu, `/pjm role set` и меню управления КМД. Оффлайн-игроки слоты не занимают.
